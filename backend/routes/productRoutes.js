...
router.post("/", protect,admin, async (req, res) => {
    try {
        ...
        const product = new Product(
            {
                name, description, price, discountPrice, countInStock, category, brand, sizes, colors, collections, material, gender, images, isFeatured, isPublished, tags, dimensions, weight, sku, user: req.user._id,//refrence to the admin user who crreated it
...
router.get("/", async (req, res) => {
    try {
      ...
      //fetch products and apply to sorting and llimit
 ...
 // route get /api/products/best-selller
  ...
  //retrieve latest 8 products by ID
  // access public
